...
//---------------------------
  ...
  if (intersections.length > 0) {
    ...
    divID.innerHTML = `${sammy.first_name}<b>${mi.id}</b>`;
    divMag.innerHTML = `${sammy.last_name}<b>${mi.mag}</b>`;
    divCrd.innerHTML = `${sammy.online}<b>${mi.crd.x.toFixed(2)}</b>; Y: <b>${mi.crd.y.toFixed(2)}</b>; Z: <b>${mi.crd.z.toFixed(2)}</b>`;
